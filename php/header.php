...
<body>
  ...
  <header class="site_header">
    <div class="header_logo"><img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/img/img_title_sub.png" alt="小布施バーチャル町民会議"></div>
    <nav class="global_menu">
      <ul class="menu">
        <li class="menu_item"><a href="#concept">コンセプト</a></li>
        <li class="menu_item"><a href="#about">小布施バーチャル町民会議とは</a></li>
        <li class="menu_item"><a href="#theme">テーマ</a></li>
        <li class="menu_item"><a href="#about-obuse">小布施町とは</a></li>
        <li class="menu_item"><a href="#schedule">日程</a></li>
        ...
        <li class="menu_item menu_item__inquery"><a href="https://forms.gle/kshh7VuiuXKm5Rsd6" target="_blank" rel="noopener noreferrer">お申し込み</a></li>
      </ul>
    </nav>
    <a href="https://forms.gle/kshh7VuiuXKm5Rsd6" target="_blank" rel="noopener noreferrer" class="button_inquery">お申込</a>
